...
const Contact = () => {
  return (
    <section className="container mx-auto py-16 px-6 dark:bg-slate-950">
      ...
      <div className="flex flex-col lg:flex-row items-center lg:space-x-10">
        {/* Contact Form */}
        <div className="w-full lg:w-1/2 bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none dark:bg-gray-700 dark:text-white"
                />
              </div>
        ...
        {/* Contact Image */}
        <div className="w-full lg:w-1/2 mt-8 lg:mt-0 md:p-8">
          <figure>
            <img
