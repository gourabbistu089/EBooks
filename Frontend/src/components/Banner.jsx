...
function Banner() {
  return (
    <div className="max-w-screen-2xl container flex flex-col md:flex-row md:justify-between md:px-20 px-4 md:gap-64 bg-[#EFFAFC] dark:bg-gray-800 transition-all duration-300">  
      {/* left side */}
      <div className='w-full md:w-1/2 mt-4 md:mt-28 md:order-1 order-2'>
        <div className='space-y-8 md:space-y-12'>
          ...
          <p className='text-xl text-gray-700 dark:text-gray-300'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut eveniet odit nostrum nulla sint delectus voluptates ipsam unde nemo assumenda, vel quis. Aperiam, aspernatur! Et aspernatur facere animi assumenda eos?
          </p>
        ...
        <button className="btn btn-secondary mt-6 dark:bg-gray-600 dark:text-white">Subscribe</button>
      </div>
